...
class UpcTemplateControllerTest {
  ...
  void testFindAllUpcTemplateTempList() throws Exception {
    ...
    mockMvc
        .perform(get("/api/upcTemplate/upcTemplateTemp/UpcTemplateTempList"))
  ...
  void testUpcTemplateTempById() throws Exception {
    ...
    StandardResponse<Object> mockResponse =
        new StandardResponse<>(true, "Success", new UpcTemplateDTO());
    when(upcTemplateService.findUpcTemplateTempById(templateId))
        .thenReturn(ResponseEntity.ok(mockResponse));

    mockMvc
        .perform(
            get("/api/upcTemplate/upcTemplateTemp/UpcTemplateTempById/{upcTemplateID}", templateId))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true));
  }
  ...
  void testFindAllApprovedUpcTemplateList() throws Exception {
    ...
    mockMvc
        .perform(get("/api/upcTemplate/upcTemplateTemp/findAllApprovedUpcTemplates"))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true));
  }
  ...
  void testFindApprovedUpcTemplateById() throws Exception {
    ...
    StandardResponse<Object> mockResponse =
        new StandardResponse<>(true, "Success", new UpcTemplateDTO());
    when(upcTemplateService.findApprovedUpcTemplateById(templateId))
        .thenReturn(ResponseEntity.ok(mockResponse));

    mockMvc
        .perform(get("/api/upcTemplate/findApprovedUpcTemplateById/{upcTemplateID}", templateId))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true));
  }
  ...
  void testSaveUpcTemplate() throws Exception {
    ...
    when(upcTemplateService.saveUpcTemplate(any(UpcTemplateDTO.class)))
        .thenReturn(ResponseEntity.ok(response));

    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/upcTemplate")
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(
                    "/api/upcTemplate/updateUpcTemplateTemp/{upcTemplateID}", templateId)
                .contentType(MediaType.APPLICATION_JSON)
                .content(new ObjectMapper().writeValueAsString(dto)))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true));
  ...
  void testApproveRejectUpcTemplate() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/api/upcTemplate/approveRejectUpcTemplate")
                .contentType(MediaType.APPLICATION_JSON)
  ...
  void testUpdateApprovedUpcTemplate() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(
                    "/api/upcTemplate/updateUpcTemplate/{upcTemplateID}", templateId)
                .contentType(MediaType.APPLICATION_JSON)
                .content(new ObjectMapper().writeValueAsString(dto)))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true));
  ...
  void testDeleteUpcTemplateFromTemp() throws Exception {
    ...
    mockMvc
        .perform(
            MockMvcRequestBuilders.post(
                    "/api/upcTemplate/upcTemplateTemp/deleteUpcTemplateFromTemp")
                .contentType(MediaType.APPLICATION_JSON)
                .content(new ObjectMapper().writeValueAsString(dto)))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.success").value(true));
