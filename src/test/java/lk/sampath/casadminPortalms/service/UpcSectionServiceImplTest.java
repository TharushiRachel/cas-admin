...
class UpcSectionServiceImplTest {
    ...
    @InjectMocks
    private UpcSectionServiceImpl upcSectionService;
    ...
    void testFindAllUpcSectionTempList_StatusCode() throws ApiRequestException {
        ...
        ResponseEntity<StandardResponse<List<UpcSectionDTO>>> response = upcSectionService.findAllUpcSectionTempList();
    ...
    void testFindUpcSectionTempByID_Success() throws ApiRequestException {
        ...
        Mockito.when(upcSectionTempRepository.findById(upcSectionID)).thenReturn(Optional.of(upcSectionTemp));

        ResponseEntity<StandardResponse<UpcSectionDTO>> response = upcSectionService.findUpcSectionTempByID(upcSectionID);
    ...
    void testFindAllApprovedUpcSection_EmptyList() {
        ...
        // Act
        ResponseEntity<StandardResponse<List<UpcSectionDTO>>> response = upcSectionService.findAllApprovedUpcSection();
    ...
    void testFindApprovedUpcSectionByID_StatusCode() {
        ...
        ResponseEntity<StandardResponse<UpcSectionDTO>> response = upcSectionService.findApprovedUpcSectionByID(upcSectionID);
    ...
    void testSaveUpcSectionTemp_Success() {
        ...
        Mockito.when(upcSectionTempRepository.findAll(Mockito.any(BooleanBuilder.class))).thenReturn(Collections.emptyList());
        Mockito.when(upcSectionTempRepository.getCurrentSequenceValue()).thenReturn(1);
        Mockito.when(upcSectionTempRepository.saveAndFlush(Mockito.any(UpcSectionTemp.class))).thenReturn(upcSectionTemp);

        ResponseEntity<StandardResponse<UpcSectionDTO>> response = upcSectionService.saveUpcSectionTemp(upcSectionDTO);
    ...
    void testApproveRejectUpcSection_ApproveSuccess() {
        ...
        Mockito.when(upcSectionRepository.saveAndFlush(Mockito.any(UpcSection.class))).thenReturn(upcSection);
        ...
        ResponseEntity<StandardResponse<UpcSectionDTO>> response = upcSectionService.approveRejectUpcSection(approveRejectRQ);
    ...
    void testUpdateApprovedUpcSection_Success() {
        ...
        Mockito.when(upcSectionRepository.findById(upcSectionID)).thenReturn(Optional.of(upcSection));
        Mockito.when(upcSectionTempRepository.exists(Mockito.any(BooleanBuilder.class))).thenReturn(false);
    ...
    void testUpdateApprovedUpcSection_DuplicateNameInTemp() {
        ...
        Mockito.when(upcSectionRepository.findById(upcSectionID)).thenReturn(Optional.of(upcSection));
        Mockito.when(upcSectionTempRepository.exists(Mockito.any(BooleanBuilder.class))).thenReturn(true);

        ApiRequestException exception = assertThrows(ApiRequestException.class,
                () -> upcSectionService.updateApprovedUpcSection(upcSectionID, upcSectionDTO));
        assertEquals("UPC Section Name 'Duplicate Name' already exists in the system.", exception.getMessage());
    }
    ...
    void testUpdateUpcSectionTemp_Success() {
        ...
        Mockito.when(upcSectionTempRepository.findById(upcSectionID)).thenReturn(Optional.of(existingUpcSectionTemp));
        Mockito.when(upcSectionTempRepository.findAll(Mockito.any(BooleanBuilder.class))).thenReturn(Collections.emptyList());
        Mockito.when(upcSectionTempRepository.saveAndFlush(Mockito.any(UpcSectionTemp.class)))
                .thenAnswer(invocation -> invocation.getArgument(0));
    ...
    void testDeleteUpcSectionFormTemp_Success() {
        ...
        ResponseEntity<StandardResponse<Void>> response = upcSectionService.deleteUpcSectionFormTemp(upcSectionID);
    ...
    void testDeleteUpcSectionFormTemp_DatabaseException() {
        ...
        Mockito.doThrow(new RuntimeException("Database Error")).when(upcSectionTempRepository).deleteById(upcSectionID);
    ...
    void testHandleApproval_CallsMapUpcSection_ForNewUser() throws ApiRequestException{
        when(upcSectionTempRepository.findById(approveRejectRQ.getApproveRejectDataID())).thenReturn(Optional.of(upcSectionTemp));
        when(upcSectionRepository.findById(upcSectionTemp.getUpcSectionID())).thenReturn(Optional.empty());
        when(upcSectionRepository.saveAndFlush(any(UpcSection.class))).thenAnswer(invocation -> invocation.getArgument(0));
    ...
    @Test
    void testHandleApproval_CallsUpdateUpcSectionToMaster_ForExistingUser() throws ApiRequestException{
        when(upcSectionTempRepository.findById(approveRejectRQ.getApproveRejectDataID())).thenReturn(Optional.of(upcSectionTemp));
        when(upcSectionRepository.findById(upcSectionTemp.getUpcSectionID())).thenReturn(Optional.of(upcSection));
        when(upcSectionRepository.saveAndFlush(any(UpcSection.class))).thenAnswer(invocation -> invocation.getArgument(0));
    ...
    void testApproveRejectUpcSection_RejectionSuccess_WithAudit() throws ApiRequestException {
        ...
        assertEquals(upcSectionTemp.getUpcSectionDescription(), capturedAudit.getUpcSectionDescription());
