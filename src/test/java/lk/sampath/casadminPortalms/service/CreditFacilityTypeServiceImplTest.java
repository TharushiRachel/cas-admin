...
class CreditFacilityTypeServiceImplTest {
    ...
    @Mock
    private CreditFacilityTypeTempRepository creditFacilityTypeTempRepository;

    @Mock
    private CreditFacilityTypeRepository creditFacilityTypeRepository;

    @Mock
    private CreditFacilityTypeAudRepository creditFacilityTypeAudRepository;
    ...
    @InjectMocks
    private CreditFacilityTypeServiceImpl creditFacilityTypeService;
    ...
    void testSaveCreditFacilityTypeTemp_Success() throws ApiRequestException {
        ...
        when(creditFacilityTypeTempRepository.save(any(CreditFacilityTypeTemp.class))).thenReturn(new CreditFacilityTypeTemp());
        when(creditFacilityTypeTempRepository.existsByFacilityTypeName(tempCreditFacilityTypeDTO.getFacilityTypeName())).thenReturn(false);
        when(creditFacilityTypeRepository.existsByFacilityTypeName(tempCreditFacilityTypeDTO.getFacilityTypeName())).thenReturn(false);
        ...
        CreditFacilityTypeDTO responseDto = (CreditFacilityTypeDTO) Objects.requireNonNull(response.getBody()).getResponse();
        assertNotNull(response);
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals("Success", response.getBody().getMessage());
        assertEquals(tempCreditFacilityTypeDTO.getFacilityTypeName(), responseDto.getFacilityTypeName());
    }
    ...
    void testSaveCreditFacilityTypeTemp_Failure_NameEmpty() {
        ...
        ApiRequestException exception = assertThrows(ApiRequestException.class, () ->
                creditFacilityTypeService.saveCreditFacilityTypeTemp(tempCreditFacilityTypeDTOWithOutName)
        );
    ...
    void testSaveCreditFacilityTypeTemp_Failure_NameAlreadyExistsInTemp() {
        ...
        when(creditFacilityTypeTempRepository.existsByFacilityTypeName(tempCreditFacilityTypeDTO.getFacilityTypeName())).thenReturn(true);


        ApiRequestException exception = assertThrows(ApiRequestException.class, () ->
                creditFacilityTypeService.saveCreditFacilityTypeTemp(tempCreditFacilityTypeDTO)
        );
        String expectedMessage =(CREDIT_FACILITY_TYPE_WITH+tempCreditFacilityTypeDTO.getFacilityTypeName()+ALL_READY_EXISTS + TEMP_TABLE);
    ...
    void testSaveCreditFacilityTypeTemp_Failure_NameAlreadyExistsInMaster() {
        ...
        when(creditFacilityTypeTempRepository.existsByFacilityTypeName(tempCreditFacilityTypeDTO.getFacilityTypeName())).thenReturn(false);
        when(creditFacilityTypeRepository.existsByFacilityTypeName(tempCreditFacilityTypeDTO.getFacilityTypeName())).thenReturn(true);
        ...
        String expectedMessage =(CREDIT_FACILITY_TYPE_WITH+tempCreditFacilityTypeDTO.getFacilityTypeName()+ALL_READY_EXISTS + MASTER_TABLE);
        assertEquals(expectedMessage, exception.getMessage());
    }

    @Test
    void testSaveCreditFacilityTypeTemp_Failure_UnhandledException() {
        when(creditFacilityTypeTempRepository.getCurrentSequenceValue()).thenThrow(new RuntimeException("Database error"));
    ...
    void testFindCreditFacilityTypeTempByID_Success() throws ApiRequestException {
        ...
        when(creditFacilityTypeTempRepository.findById(1)).thenReturn(Optional.of(creditFacilityTypeTemp));
    ...
    void testFindCreditFacilityTypeTempByID_UnhandledException() {
        ...
        when(creditFacilityTypeTempRepository.findById(anyInt())).thenThrow(new RuntimeException("Database error"));
    ...
    void testUpdateCreditFacilityTempType_Failure_NameInMasterRecords() {
        ...
        when(creditFacilityTypeTempRepository.findById(1)).thenReturn(Optional.of(creditFacilityTypeTemp));
        when(creditFacilityTypeTempRepository.existsByFacilityTypeName("Temp DTO")).thenReturn(false);
        when(creditFacilityTypeRepository.findCreditFacilityTypeByName("Temp DTO")).thenReturn(masterRecord);
    ...
    void testUpdateCreditFacilityTempType_Failure_UnhandledException() {
        ...
        when(creditFacilityTypeTempRepository.findById(1)).thenThrow(new RuntimeException("Database error"));
    ...
    void testApproveRejectCreditFacilityType_Success_ApproveNew() {
        ...
        when(creditFacilityTypeRepository.save(any(CreditFacilityType.class))).thenReturn(creditFacilityType);
    ...
    void testApproveRejectCreditFacilityType_Success_ApproveNewIdNotEqual() {
        ...
        when(creditFacilityTypeTempRepository.findById(1)).thenReturn(Optional.of(creditFacilityTypeTemp));
        when(creditFacilityTypeRepository.findById(1)).thenReturn(Optional.ofNullable(creditFacilityType));
        when(creditFacilityTypeRepository.save(any(CreditFacilityType.class))).thenReturn(creditFacilityType);
        when(creditFacilityTypeAudRepository.save(any(CreditFacilityTypeAud.class))).thenReturn(audit);
    ...
    void testApproveRejectCreditFacilityType_Success_Reject() {
        ...
        ArgumentCaptor<CreditFacilityTypeAud> auditCaptor = ArgumentCaptor.forClass(CreditFacilityTypeAud.class);
        ...
        assertEquals(creditFacilityTypeTemp.getCreditFacilityTypeID(), capturedAudit.getCreditFacilityTypeID());
    ...
    void testApproveRejectCreditFacilityType_InvalidRequest() {
        ...
        assertEquals("Invalid ApproveRejectRQ for creditfacilitytype: CreditFacilityTypeID cannot be null", exception.getMessage());
    }
    ...
    void testApproveRejectCreditFacilityType_Failure_ApproveNew() {
        ...
        when(creditFacilityTypeAudRepository.save(any(CreditFacilityTypeAud.class))).thenThrow(new RuntimeException("Database error"));
    ...
    void testUpdateApprovedCreditFacilityType_Failure_UnhandledException() {
        ...
        when(creditFacilityTypeRepository.findById(1)).thenThrow(new RuntimeException("Database error"));
    ...
    void testSearchCreditFacilityTypes_Success() throws ApiRequestException {
        ...
        List<CreditFacilityType> creditFacilityTypeList = Collections.singletonList(creditFacilityType);
        when(creditFacilityTypeRepository.findAllApprovedCreditFacilityTypes()).thenReturn(creditFacilityTypeList);


        when(modelMapper.map(creditFacilityTypeList.get(0), CreditFacilityTypeDTO.class))
                .thenReturn(new CreditFacilityTypeDTO(creditFacilityTypeList.get(0)));


        ResponseEntity<StandardResponse<List<CreditFacilityTypeDTO>>> response =
                creditFacilityTypeService.searchCreditFacilityTypes();
        ...
        List<CreditFacilityTypeDTO> responseLIst = (List<CreditFacilityTypeDTO>) response.getBody().getResponse();

        assertEquals("Loan", responseLIst.get(0).getFacilityTypeName());
    ...
    void testSearchCreditFacilityTypes_EmptyResult() throws ApiRequestException {
        ...
        when(creditFacilityTypeRepository.findAllApprovedCreditFacilityTypes()).thenReturn(new ArrayList<>());
        ...
        assertEquals(HttpStatus.OK, response.getStatusCode());
        assertEquals("Success", response.getBody().getMessage());
        assertEquals(0, ((List<CreditFacilityTypeDTO>)response.getBody().getResponse()).size());
    }

    @Test
    void testSearchCreditFacilityTypes_UnhandledException() {

        when(creditFacilityTypeRepository.findAllApprovedCreditFacilityTypes())
        ...
        assertEquals("Unable to Fetch Credit Facility Types", exception.getMessage());
    }
    ...
    void testFindAllCreditFacilityTypeTempList_Success() throws ApiRequestException {
        ...
        List<CreditFacilityTypeTemp> creditFacilityTypeTempList = Collections.singletonList(creditFacilityTypeTemp);

        when(creditFacilityTypeTempRepository.findAll()).thenReturn(creditFacilityTypeTempList);


        ResponseEntity<StandardResponse<List<CreditFacilityTypeDTO>>> response =
                creditFacilityTypeService.findAllCreditFacilityTypeTempList();
    ...
    void testFindAllCreditFacilityTypeTempList_EmptyResult() throws ApiRequestException {
        ...
        when(creditFacilityTypeTempRepository.findAll()).thenReturn(new ArrayList<>());
    ...
    void testFindAllCreditFacilityTypeTempList_UnhandledException() {
        ...
        when(creditFacilityTypeTempRepository.findAll()).thenThrow(new RuntimeException("Database error"));
