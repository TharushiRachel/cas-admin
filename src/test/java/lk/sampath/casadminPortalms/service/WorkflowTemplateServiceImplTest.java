...
class WorkflowTemplateServiceImplTest {
    ...
    @InjectMocks
    WorkflowTemplateServiceImpl workflowTemplateServiceImpl;


    @Mock
    WorkflowTemplateDTO newWorkflowTemplateDTO;

    @Mock
    WorkflowTemplateDTO existingWorkflowTemplateDTO;
    ...
    @Mock
    ApproveRejectRQ approveRejectRQ;
    ...
    void setup() {
        ...
        newWorkflowTemplateDTO = WorkflowTemplateDTO.builder()
        ...
        existingWorkflowTemplateDTO = WorkflowTemplateDTO.builder()
        ...
        workFlowTemplateDataDTO = WorkFlowTemplateDataDTO.builder()
        ...
        workflowTemplateDataTemp = WorkflowTemplateDataTemp.builder()
        ...
        workflowTemplateTemp = WorkflowTemplateTemp.builder()
                .workFlowTemplateId(1)
    ...
    void testGetAllApprovedUPMGroups() {
        ...
        StandardResponse<List<UpmGroupDTO>> response = workflowTemplateServiceImpl.getAllApprovedUPMGroups();
    ...
    void testAuthorizeWorkflowTemplateTemp() {
        Date date = new Date();
        when(workflowTemplateTempRepository.findById(10)).thenReturn(Optional.ofNullable(workflowTemplateTemp));
        ApiRequestException exception = assertThrows(ApiRequestException.class, () -> {
            workflowTemplateServiceImpl.authorizeWorkflowTemplateTemp(approveRejectRQ);
        });
        assertEquals("Not Found", exception.getMessage());

        when(workflowTemplateTempRepository.findById(1)).thenReturn(Optional.ofNullable(workflowTemplateTemp));
        approveRejectRQ.setApproveStatus(MasterDataApproveStatus.PENDING);
        StandardResponse<Boolean> response = workflowTemplateServiceImpl.authorizeWorkflowTemplateTemp(approveRejectRQ);
        assertEquals(new StandardResponse<>(ErrorEnums.SUCCESS_CODE.getStatus(), ErrorEnums.SUCCESS_CODE.getLabel(),
                true), response);
        ...
        WorkflowTemplate workflowTemplate = workflowTemplateServiceImpl.workflowTemplateMapper(workflowTemplateTemp);
        ...
        workflowTemplate.setWorkFlowTemplateDataSet(workflowTemplateServiceImpl.getTempWorkflowTemplateData(workflowTemplateTemp));
