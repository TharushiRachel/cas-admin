...
class UpmGroupServiceImplTest {
    ...
    @InjectMocks
    private UpmGroupServiceImpl upmGroupService;
    ...
    void testFindUpmGroupTempList_Success() throws Exception {
        ...
        ResponseEntity<StandardResponse<List<UpmGroupDTO>>> response = upmGroupService.findAllUpmGroupTempList();
    ...
    void testFindUpmGroupTempById_Success() throws ApiRequestException{
        when(upmGroupTempRepository.findById(upmGroupTemp.getUpmGroupID())).thenReturn(Optional.of(upmGroupTemp));

        ResponseEntity<StandardResponse<UpmGroupDTO>> response = upmGroupService.findUpmGroupTempByID(upmGroupTemp.getUpmGroupID());
    ...
    void testFindApprovedUpmGroupById_Success() throws ApiRequestException{
        ...
        ResponseEntity<StandardResponse<UpmGroupDTO>> response = upmGroupService.findUpmGroupById(upmGroup.getUpmGroupID());
    ...
    void testSaveUpmGroupTemp_Success() throws ApiRequestException{
        when(upmGroupTempRepository.findAll(any(BooleanBuilder.class))).thenReturn(Collections.emptyList());
        ...
        ResponseEntity<StandardResponse<UpmGroupDTO>> response = upmGroupService.saveUPMGroupTemp(upmGroupDTO);
    ...
    void testSaveUpmGroupTemp_UserAlreadyExists() throws ApiRequestException{
        when(upmGroupTempRepository.findAll(any(BooleanBuilder.class))).thenReturn(List.of(upmGroupTemp));
    ...
    void testApproveRejectUpmGroup_Success() throws ApiRequestException{
        when(upmGroupTempRepository.findById(approveRejectRQ.getApproveRejectDataID())).thenReturn(Optional.of(upmGroupTemp));
        when(upmGroupRepository.findById(upmGroupTemp.getUpmGroupID())).thenReturn(Optional.of(upmGroup));

        ResponseEntity<StandardResponse<UpmGroupDTO>> response = upmGroupService.approveRejectUpmGroup(approveRejectRQ);
    ...
    void testApproveRejectUpmGroup_NotFound() {
        when(upmGroupTempRepository.findById(approveRejectRQ.getApproveRejectDataID())).thenReturn(Optional.empty());
        ApiRequestException exception = assertThrows(ApiRequestException.class, () -> {
    ...
    void testHandleApproval_CallsMapUpmGroup_ForNewUser() throws ApiRequestException{
        ...
        when(upmGroupRepository.save(any(UpmGroup.class))).thenAnswer(invocation -> invocation.getArgument(0));
    ...
    void testUpdateUpmGroupTemp_Success() throws ApiRequestException{
        ...
        ResponseEntity<StandardResponse<UpmGroupDTO>> response = upmGroupService.updateUpmGroupTemp(1, upmGroupDTO);
    ...
    void testUpdateUpmGroup_DocumentNameConflict(){
        ...
        when(upmGroupTempRepository.findById(1)).thenReturn(Optional.of(upmGroupTemp));
        when(upmGroupTempRepository.findAll(any(BooleanBuilder.class))).thenReturn(List.of(conflictingUser));
    ...
    void testUpdateApprovedUpmGroup_Success() throws ApiRequestException{
        when(upmGroupRepository.findById(upmGroupDTO.getUpmGroupID())).thenReturn(Optional.of(upmGroup));
        ...
        when(upmGroupTempRepository.save(any(UpmGroupTemp.class))).thenAnswer(invocation -> invocation.getArgument(0));

        ResponseEntity<StandardResponse<UpmGroupDTO>> response = upmGroupService.updateApprovedUpmGroup(1, upmGroupDTO);
    ...
    void testUpdateApprovedUpmGroup_DocumentNameConflictInTemp() {
        ...
        assertEquals("Group Code 'Old Unit Testing' already exists in the system.", exception.getMessage());
    }
