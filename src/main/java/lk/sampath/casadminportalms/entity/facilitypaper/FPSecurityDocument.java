...
public class FPSecurityDocument implements Serializable {
  ...
  @GeneratedValue(
      ...
      generator = "SEQ_T_FACILITY_SECURITY_DOCUMENT")
  @SequenceGenerator(
      name = "SEQ_T_FACILITY_SECURITY_DOCUMENT",
      sequenceName = "SEQ_T_FACILITY_SECURITY_DOCUMENT",
      allocationSize = 1)
