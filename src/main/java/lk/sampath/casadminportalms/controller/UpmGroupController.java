...
public class UpmGroupController {
  ...
  public ResponseEntity<StandardResponse<UpmGroupDTO>> viewUpmGroupTempByID(
      @PathVariable int upmGroupID) throws ApiRequestException {
    ResponseEntity<StandardResponse<UpmGroupDTO>> upmGroupTempDTO =
        upmGroupService.findUpmGroupTempByID(upmGroupID);
  ...
  public ResponseEntity<StandardResponse<List<UpmGroupDTO>>> listUpmGroupTemp()
    ...
    ResponseEntity<StandardResponse<List<UpmGroupDTO>>> upmGroupTempList =
        upmGroupService.findAllUpmGroupTempList();
    return ResponseEntity.ok().body(upmGroupTempList.getBody());
  }

  @GetMapping("/{upmGroupID}")
  public ResponseEntity<StandardResponse<UpmGroupDTO>> viewUpmGroupById(
      @PathVariable int upmGroupID) {
    ResponseEntity<StandardResponse<UpmGroupDTO>> upmGroup =
        upmGroupService.findUpmGroupById((upmGroupID));
  ...
  public ResponseEntity<StandardResponse<List<UpmGroupDTO>>> getPagedUpmGroupData()
      throws ApiRequestException {
    ResponseEntity<StandardResponse<List<UpmGroupDTO>>> upmGroupList =
        upmGroupService.searchUpmGroups();
    return ResponseEntity.ok().body(upmGroupList.getBody());
  }

  @PostMapping("/saveUpmGroup")
  public ResponseEntity<StandardResponse<UpmGroupDTO>> saveUPMGroup(
      @Validated @RequestBody UpmGroupDTO request) throws ApiRequestException {
    ResponseEntity<StandardResponse<UpmGroupDTO>> upmGroup =
        upmGroupService.saveUPMGroupTemp(request);
    return ResponseEntity.ok().body(upmGroup.getBody());
  }

  @PostMapping("/updateUpmGroupTemp/{upmGroupID}")
  public ResponseEntity<StandardResponse<UpmGroupDTO>> updateUpmGroupTemp(
      @PathVariable int upmGroupID, @Validated @RequestBody UpmGroupDTO request)
      throws ApiRequestException {
    ResponseEntity<StandardResponse<UpmGroupDTO>> upmGroup =
        upmGroupService.updateUpmGroupTemp(upmGroupID, request);
    return ResponseEntity.ok().body(upmGroup.getBody());
  }
  ...
  public ResponseEntity<StandardResponse<UpmGroupDTO>> updateApprovedUpmGroup(
      ...
      throws ApiRequestException {
    ResponseEntity<StandardResponse<UpmGroupDTO>> upmGroup =
        upmGroupService.updateApprovedUpmGroup(upmGroupID, request);
    return ResponseEntity.ok().body(upmGroup.getBody());
  }

  @PostMapping("/deleteUpmGroup")
  public ResponseEntity<StandardResponse<Void>> deleteUpmGroup(
      @Validated @RequestBody UpmGroupDTO request) throws ApiRequestException {
    ResponseEntity<StandardResponse<Void>> upmGroup =
        upmGroupService.deleteUpmGroup(request.getUpmGroupID());
    return ResponseEntity.ok().body(upmGroup.getBody());
  }

  @GetMapping("/activeUpmGroups")
  public ResponseEntity<StandardResponse<List<UpmGroupDTO>>> activeUpmGroups()
      throws ApiRequestException {
    ResponseEntity<StandardResponse<List<UpmGroupDTO>>> upmGroupTempList =
