...
public class RoleController {
  ...
  public ResponseEntity<StandardResponse<List<PrivilegeCategory>>> findAllPrivilegeCategories(
    ...
    ResponseEntity<StandardResponse<List<PrivilegeCategory>>> privilegeCategories =
  ...
  public ResponseEntity<StandardResponse<Object>> viewTempRoleById(@PathVariable Integer roleID)
      throws ApiRequestException {
  ...
  public ResponseEntity<StandardResponse<List<RoleDTO>>> viewTempRoleList(
      ...
      throws ApiRequestException {
    Pageable pageable = PaginationUtil.createPageable(headerPage, headerSize, page, size);
    ResponseEntity<StandardResponse<List<RoleDTO>>> role =
  ...
  public ResponseEntity<StandardResponse<Page<RoleDTO>>> listRole(
      ...
      throws ApiRequestException {
    Pageable pageable = PaginationUtil.createPageable(headerPage, headerSize, page, size);
    ResponseEntity<StandardResponse<Page<RoleDTO>>> roles =
        roleService.findAllApprovedRoles(pageable);
    return ResponseEntity.ok().body(roles.getBody());
  }

  @GetMapping("/{roleID}")
  public ResponseEntity<StandardResponse<Object>> viewRoleById(@PathVariable Integer roleID)
      throws ApiRequestException {
  ...
  public ResponseEntity<StandardResponse<Object>> saveRole(@Validated @RequestBody RoleDTO request)
      throws ApiRequestException {
  ...
  public ResponseEntity<StandardResponse<Object>> updateRole(
      @PathVariable Integer roleID, @Validated @RequestBody RoleDTO request)
      throws ApiRequestException {
  ...
  public ResponseEntity<StandardResponse<Object>> approveRejectRole(
  ...
  public ResponseEntity<StandardResponse<List<UpmRolePrivilegeDTO>>> getPrivilegesByCode(
      @PathVariable int groupCode) throws ApiRequestException {
    ResponseEntity<StandardResponse<List<UpmRolePrivilegeDTO>>> role =
