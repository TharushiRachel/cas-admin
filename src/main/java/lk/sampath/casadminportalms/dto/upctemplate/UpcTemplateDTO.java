...
public class UpcTemplateDTO {
  ...
  public UpcTemplateDTO(UpcTemplateTemp upcTemplate) {
    ...
    if (upcTemplate.getUpcTemplateDataTempList() != null
        && !upcTemplate.getUpcTemplateDataTempList().isEmpty()) {
      ...
      this.upcTemplateDataDTOList.sort(
          Comparator.comparingInt(UpcTemplateDataDTO::getDisplayOrder));
    } else {
      this.upcTemplateDataDTOList = new ArrayList<>();
    }
  }
  ...
  public UpcTemplateDTO(UpcTemplate upcTemplate) {
    ...
    if (upcTemplate.getUpcTemplateDataList() != null
        && !upcTemplate.getUpcTemplateDataList().isEmpty()) {
      this.upcTemplateDataDTOList = new ArrayList<>();
