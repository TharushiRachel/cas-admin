...
public class RoleDTO {
  ...
  public RoleDTO(Role role) {
    ...
    this.privileges = role.getPrivileges().stream().map(Privilege::getPrivilegeID).toList();
  ...
  public RoleDTO(RoleTemp roleTemp) {
    ...
    this.privileges = roleTemp.getPrivileges().stream().map(Privilege::getPrivilegeID).toList();
