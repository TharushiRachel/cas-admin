...
public interface CreditFacilityTypeService {
    ...
    ResponseEntity<StandardResponse<List<CreditFacilityTypeDTO>>> searchCreditFacilityTypes(Pageable pageable) throws ApiRequestException;
    ...
    ResponseEntity<StandardResponse<List<CreditFacilityTypeDTO>>> findAllCreditFacilityTypeTempList(Pageable pageable) throws ApiRequestException;
