...
public interface WorkflowTemplateService  {
    ...
    StandardResponse<Page<WorkflowTemplateDTO>> getWorkflowTemplate(Pageable pageable)throws ApiRequestException;

    StandardResponse<Boolean>  authorizeWorkflowTemplateTemp(ApproveRejectRQ approveRejectRQ)throws ApiRequestException;

    ResponseEntity<StandardResponse<Void>> deleteWorkFlowTempById(Integer approveRejectDataID) throws ApiRequestException;
}
