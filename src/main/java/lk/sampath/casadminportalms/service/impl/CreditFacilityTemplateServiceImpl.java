...
public class CreditFacilityTemplateServiceImpl implements CreditFacilityTemplateService {
  ...
  public CreditFacilityTemplateServiceImpl(
      CreditFacilityTemplateRepository creditFacilityTemplateRepository,
      CreditFacilityTemplateTempRepository creditFacilityTemplateTempRepository,
      CreditFacilityTypeRepository creditFacilityTypeDao,
      CreditFacilityTemplateAudRepo creditFacilityTemplateAudRepo,
      CftInterestRateRepository cftInterestRateRepository,
      CftInterestRateTempRepository cftInterestRateTempRepository,
      CftVitalInfoTempRepository cftVitalInfoTempRepository,
      CftVitalInfoRepository cftVitalInfoRepository,
      CftCustomFacilityInfoTempRepository cftCustomFacilityInfoTempRepository,
      CftCustomFacilityInfoRepository cftCustomFacilityInfoRepository,
      CftSupportingDocRepository cftSupportingDocRepository,
      CftSupportingDocTempRepository cftSupportingDocTempRepository,
      SupportingDocRepository supportingDocRepository,
      CftOtherFacilityInfoRepository otherFacilityInfoRepository,
      CftOtherFacilityInfoTempRepository otherFacilityInfoTempRepository,
      CftInterestRateAudRepo cftInterestRateAudRepo,
      CftVitalInfoAudRepo cftVitalInfoAudRepo,
      CftCustomFacilityInfoAudRepo cftCustomFacilityInfoAudRepo,
      CftSupportingDocAudRepo cftSupportingDocAudRepo,
      CftOtherFacilityInfoAudRepo cftOtherFacilityInfoAudRepo) {
  ...
  public ResponseEntity<StandardResponse<CreditFacilityTemplateDTO>>
      getCreditFacilityTemplateTempByID(Integer creditFacilityTemplateID) {

    CreditFacilityTemplateTemp creditFacilityTemplateTemp =
        creditFacilityTemplateTempRepository
            .findById(creditFacilityTemplateID)
            .orElseThrow(
                () -> {
                  throw new ApiRequestException(
                      "Credit Facility Template Temp with"
                          + creditFacilityTemplateID
                          + DOES_NOT_EXISTS);
                });

    CreditFacilityTemplateDTO creditFacilityTemplateDTO =
        new CreditFacilityTemplateDTO(creditFacilityTemplateTemp);
  ...
  @Override
  @Transactional(propagation = Propagation.REQUIRED, rollbackFor = ApiRequestException.class)
  public ResponseEntity<StandardResponse<CreditFacilityTemplateDTO>> getCreditFacilityTemplateByID(
      Integer creditFacilityTemplateID) {

    CreditFacilityTemplate creditFacilityTemplate =
        creditFacilityTemplateRepository
            .findById(creditFacilityTemplateID)
            .orElseThrow(
                () -> {
                  throw new ApiRequestException(
                      "Credit Facility Template  with"
                          + creditFacilityTemplateID
                          + DOES_NOT_EXISTS);
                });

    CreditFacilityTemplateDTO creditFacilityTemplateDTO =
        new CreditFacilityTemplateDTO(creditFacilityTemplate);
  ...
  @Override
  @Transactional(propagation = Propagation.REQUIRED, rollbackFor = ApiRequestException.class)
  public ResponseEntity<StandardResponse<CreditFacilityTemplateDTO>> saveCreditFacilityTemplateTemp(
    ...
    booleanBuilder.and(
        QCreditFacilityTemplateTemp.creditFacilityTemplateTemp.creditFacilityName.eq(
            creditFacilityTemplateDTO.getCreditFacilityName()));
    List<CreditFacilityTemplateTemp> creditFacilityTemplateTempList =
        (List<CreditFacilityTemplateTemp>)
            creditFacilityTemplateTempRepository.findAll(booleanBuilder);

    BooleanBuilder booleanBuilderForMaster = new BooleanBuilder();
    booleanBuilderForMaster.and(
        QCreditFacilityTemplate.creditFacilityTemplate.creditFacilityName.eq(
            creditFacilityTemplateDTO.getCreditFacilityName()));
    List<CreditFacilityTemplate> creditFacilityTemplateList =
        (List<CreditFacilityTemplate>)
            creditFacilityTemplateRepository.findAll(booleanBuilderForMaster);
    ...
    if (creditFacilityTemplateTempList.isEmpty() && creditFacilityTemplateList.isEmpty()) {
      ...
      creditFacilityTemplateTemp =
          createCreditFacilityTemplateTempObj(creditFacilityTemplateDTO, true);

      Set<CftInterestRateTemp> cftInterestRateTempList =
          saveCtfInterestRateTemp(creditFacilityTemplateDTO, creditFacilityTemplateTemp);
      Set<CftVitalInfoTemp> cftVitalInfoTempList =
          saveCftVitalInfoTemp(creditFacilityTemplateDTO, creditFacilityTemplateTemp);
      Set<CftCustomFacilityInfoTemp> customFacilityInfoTempList =
          saveCftCustomFacilityInfoTemp(creditFacilityTemplateDTO, creditFacilityTemplateTemp);
      Set<CftSupportingDocTemp> cftSupportingDocTempList =
          saveCftSupportingDocTemp(creditFacilityTemplateDTO, creditFacilityTemplateTemp);
      Set<CftOtherFacilityInformationTemp> cftOtherFacilityInformationTempList =
          saveCftOtherFacilityInfoTemp(creditFacilityTemplateDTO, creditFacilityTemplateTemp);
      ...
      creditFacilityTemplateTemp.setCftOtherFacilityInformations(
          cftOtherFacilityInformationTempList);

      creditFacilityTemplateTemp.setLastModifiedDate(new Date());

      creditFacilityTemplateTemp.setCreditFacilityTemplateID(nextId);
      newCreditFacilityTemplateTemp =
          creditFacilityTemplateTempRepository.saveAndFlush(creditFacilityTemplateTemp);
    ...
    } else if (creditFacilityTemplateDTO.getCreditFacilityName() == null
        || creditFacilityTemplateDTO.getCreditFacilityName().isEmpty()) {
      throw new ApiRequestException("Credit Facility Template Name cannot be empty or null.");
    }

    CreditFacilityTemplateDTO facilityTemplateDTO =
        new CreditFacilityTemplateDTO(newCreditFacilityTemplateTemp);
    StandardResponse<CreditFacilityTemplateDTO> response =
        new StandardResponse<>(
            ErrorEnums.SUCCESS_CODE.getStatus(),
            ErrorEnums.SUCCESS_CODE.getLabel(),
  ...
  public ResponseEntity<StandardResponse<CreditFacilityTemplateDTO>>
    ...
    CreditFacilityTemplateTemp existCreditFacilityTemplateTemp =
        creditFacilityTemplateTempRepository
            .findById(creditFacilityTemplateID)
            .orElseThrow(() -> new ApiRequestException(NOT_FOUND_RECORD_MSG));

    Optional<CreditFacilityTemplate> optionalCreditFacilityTemplate =
        creditFacilityTemplateRepository.findById(creditFacilityTemplateID);

    if (!existCreditFacilityTemplateTemp
        .getCreditFacilityName()
        .equals(creditFacilityTemplateDTO.getCreditFacilityName())) {
      validateRoleNameUniqueness(creditFacilityTemplateDTO.getCreditFacilityName());

      CreditFacilityTemplateTemp finalExistCreditFacilityTemplateTemp =
          existCreditFacilityTemplateTemp;

      optionalCreditFacilityTemplate.ifPresent(
          creditFacilityTemplate -> {
            if (!creditFacilityTemplate
                .getCreditFacilityTemplateID()
                .equals(finalExistCreditFacilityTemplateTemp.getCreditFacilityTemplateID())) {
              validateRoleNameUniqueness(creditFacilityTemplateDTO.getCreditFacilityName());
            }
          });
    }

    existCreditFacilityTemplateTemp.setCreditFacilityName(
        creditFacilityTemplateDTO.getCreditFacilityName());
    existCreditFacilityTemplateTemp.setDescription(creditFacilityTemplateDTO.getDescription());
    existCreditFacilityTemplateTemp.setMaxFacilityAmount(
        creditFacilityTemplateDTO.getMaxFacilityAmount());
    existCreditFacilityTemplateTemp.setMinFacilityAmount(
        creditFacilityTemplateDTO.getMinFacilityAmount());
    ...
    existCreditFacilityTemplateTemp.setShowCalculator(
        creditFacilityTemplateDTO.getShowCalculator());
    existCreditFacilityTemplateTemp.setShowRentalData(
        creditFacilityTemplateDTO.getShowRentalData());
    ...
    existCreditFacilityTemplateTemp.setNewFacilityEmail(
        creditFacilityTemplateDTO.getNewFacilityEmail());
    existCreditFacilityTemplateTemp.setExistingFacilityEmail(
        creditFacilityTemplateDTO.getExistingFacilityEmail());
    ...
    if (creditFacilityTemplateDTO.getCreditFacilityTypeID() != null) {
      CreditFacilityType creditFacilityType =
          creditFacilityTypeDao
              .findById(creditFacilityTemplateDTO.getCreditFacilityTypeID())
              .orElseThrow(
                  () ->
                      new ApiRequestException(
                          "Credit Facility Type with ID "
                              + creditFacilityTemplateDTO.getCreditFacilityTypeID()
                              + " does not exist."));
    ...
    Set<CftInterestRateTemp> cftInterestRateTempList =
        saveCtfInterestRateTemp(creditFacilityTemplateDTO, existCreditFacilityTemplateTemp);
    Set<CftVitalInfoTemp> cftVitalInfoTempList =
        saveCftVitalInfoTemp(creditFacilityTemplateDTO, existCreditFacilityTemplateTemp);
    Set<CftCustomFacilityInfoTemp> customFacilityInfoTempList =
        saveCftCustomFacilityInfoTemp(creditFacilityTemplateDTO, existCreditFacilityTemplateTemp);
    Set<CftSupportingDocTemp> cftSupportingDocTempList =
        saveCftSupportingDocTemp(creditFacilityTemplateDTO, existCreditFacilityTemplateTemp);
    Set<CftOtherFacilityInformationTemp> cftOtherFacilityInformationTempList =
        saveCftOtherFacilityInfoTemp(creditFacilityTemplateDTO, existCreditFacilityTemplateTemp);
    ...
    existCreditFacilityTemplateTemp.setCftOtherFacilityInformations(
        cftOtherFacilityInformationTempList);

    newCreditFacilityTemplateTemp =
        creditFacilityTemplateTempRepository.saveAndFlush(existCreditFacilityTemplateTemp);
  ...
  public CreditFacilityTemplateTemp createCreditFacilityTemplateTempObj(
      CreditFacilityTemplateDTO creditFacilityTemplateDTO, Boolean isNew) {
    Date date = new Date();
    ...
    creditFacilityTemplateTemp.setCreditFacilityName(
        creditFacilityTemplateDTO.getCreditFacilityName());
    creditFacilityTemplateTemp.setDescription(creditFacilityTemplateDTO.getDescription());
    creditFacilityTemplateTemp.setMaxFacilityAmount(
        creditFacilityTemplateDTO.getMaxFacilityAmount());
    creditFacilityTemplateTemp.setMinFacilityAmount(
        creditFacilityTemplateDTO.getMinFacilityAmount());
    ...
    creditFacilityTemplateTemp.setExistingFacilityEmail(
        creditFacilityTemplateDTO.getExistingFacilityEmail());
  ...
  private CreditFacilityTemplateAud insertToAuditTable(
      CreditFacilityTemplateTemp creditFacilityTemplateTemp) {
    CreditFacilityTemplateAud creditFacilityTemplateAud = new CreditFacilityTemplateAud();

    creditFacilityTemplateAud.setCreditFacilityTemplateID(
        creditFacilityTemplateTemp.getCreditFacilityTemplateID());
    creditFacilityTemplateAud.setCreditFacilityType(
        creditFacilityTemplateTemp.getCreditFacilityType().getCreditFacilityTypeID());
    creditFacilityTemplateAud.setApproveStatus(creditFacilityTemplateTemp.getApproveStatus());
    creditFacilityTemplateAud.setCreditFacilityName(
        creditFacilityTemplateTemp.getCreditFacilityName());
    creditFacilityTemplateAud.setDescription(creditFacilityTemplateTemp.getDescription());
    creditFacilityTemplateAud.setMaxFacilityAmount(
        creditFacilityTemplateTemp.getMaxFacilityAmount());
    creditFacilityTemplateAud.setMinFacilityAmount(
        creditFacilityTemplateTemp.getMinFacilityAmount());
    ...
    creditFacilityTemplateAud.setExistingFacilityEmail(
        creditFacilityTemplateTemp.getExistingFacilityEmail());
  ...
  @Transactional(propagation = Propagation.REQUIRED, rollbackFor = ApiRequestException.class)
  public ResponseEntity<StandardResponse<CreditFacilityTemplateDTO>>
      authorizeCreditFacilityTemplate(ApproveRejectRQ approveRejectRQ) throws ApiRequestException {
    ...
    CreditFacilityTemplateTemp creditFacilityTemplateTemp =
        creditFacilityTemplateTempRepository
            ...
            .orElseThrow(
                () -> {
                  throw new ApiRequestException(NOT_FOUND_RECORD_MSG);
                });

    Optional<CreditFacilityTemplate> optionalCreditFacilityTemplate =
        creditFacilityTemplateRepository.findById(
            creditFacilityTemplateTemp.getCreditFacilityTemplateID());
    ...
    CreditFacilityTemplateTemp newCft =
        creditFacilityTemplateTempRepository.saveAndFlush(creditFacilityTemplateTemp);
  ...
  private ResponseEntity<StandardResponse<CreditFacilityTemplateDTO>> handleApproval(
      CreditFacilityTemplateTemp creditFacilityTemplateTemp,
      CreditFacilityTemplate facilityTemplate) {
    ...
    if (facilityTemplate != null
        && facilityTemplate
            .getCreditFacilityTemplateID()
            .equals(creditFacilityTemplateTemp.getCreditFacilityTemplateID())) {
      creditFacilityTemplateDTO =
          updateCreditFacilityTemplateToMaster(creditFacilityTemplateTemp, facilityTemplate);
    } else {
  ...
  private ResponseEntity<StandardResponse<CreditFacilityTemplateDTO>> handleRejection(
      CreditFacilityTemplateTemp newCft) {
  ...
  private CreditFacilityTemplateDTO createCreditFacilityTemplateObj(
      CreditFacilityTemplateTemp creditFacilityTemplateTemp) {

    CreditFacilityTemplate creditFacilityTemplate = new CreditFacilityTemplate();

    creditFacilityTemplate.setCreditFacilityTemplateID(
        creditFacilityTemplateTemp.getCreditFacilityTemplateID());
    creditFacilityTemplate.setCreditFacilityName(
        creditFacilityTemplateTemp.getCreditFacilityName());
    creditFacilityTemplate.setCreditFacilityType(
        creditFacilityTemplateTemp.getCreditFacilityType());
    ...
    creditFacilityTemplate.setExistingFacilityEmail(
        creditFacilityTemplateTemp.getExistingFacilityEmail());
    ...
    Set<CftInterestRate> cftInterestRateList =
        authorizeCftInterestRate(
            creditFacilityTemplateTemp.getCftInterestRates(), creditFacilityTemplate);
    creditFacilityTemplate.setCftInterestRates(cftInterestRateList);

    Set<CftVitalInfo> cftVitalInfoSet =
        authorizeCftVitalInfo(
            creditFacilityTemplateTemp.getCftVitalInfos(), creditFacilityTemplate);
    creditFacilityTemplate.setCftVitalInfos(cftVitalInfoSet);

    Set<CftSupportingDoc> cftSupportingDocSet =
        authorizeCftSupportingDoc(
            creditFacilityTemplateTemp.getCftSupportingDocs(), creditFacilityTemplate);
    creditFacilityTemplate.setCftSupportingDocs(cftSupportingDocSet);

    Set<CftOtherFacilityInformation> otherFacilityInformationSet =
        authorizeCftOtherFacilityInformation(
            creditFacilityTemplateTemp.getCftOtherFacilityInformations(), creditFacilityTemplate);
    creditFacilityTemplate.setCftOtherFacilityInformations(otherFacilityInformationSet);

    Set<CftCustomFacilityInfo> cftCustomFacilityInfoSet =
        authorizeCftCustomFacilityInfo(
            creditFacilityTemplateTemp.getCftCustomFacilityInfos(), creditFacilityTemplate);
  ...
  private CreditFacilityTemplateDTO updateCreditFacilityTemplateToMaster(
      CreditFacilityTemplateTemp creditFacilityTemplateTemp,
      CreditFacilityTemplate facilityTemplate) {

    CreditFacilityTemplate creditFacilityTemplate =
        (facilityTemplate != null) ? facilityTemplate : new CreditFacilityTemplate();
    ...
    List<CftVitalInfo> cftVitalInfoList =
        cftVitalInfoRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
            creditFacilityTemplate.getCreditFacilityTemplateID());
    ...
    List<CftInterestRate> cftInterestRateList =
        cftInterestRateRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
            creditFacilityTemplate.getCreditFacilityTemplateID());
    cftInterestRateRepository.deleteAll(cftInterestRateList);
    Set<CftInterestRate> cftInterestRateSet =
        authorizeCftInterestRate(
            creditFacilityTemplateTemp.getCftInterestRates(), creditFacilityTemplate);
    creditFacilityTemplate.setCftInterestRates(cftInterestRateSet);

    List<CftSupportingDoc> cftSupportingDocList =
        cftSupportingDocRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
            creditFacilityTemplate.getCreditFacilityTemplateID());
    ...
    List<CftOtherFacilityInformation> cftOtherFacilityInformationList =
        otherFacilityInfoRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
            creditFacilityTemplate.getCreditFacilityTemplateID());
    ...
    List<CftCustomFacilityInfo> cftCustomFacilityInfoList =
        cftCustomFacilityInfoRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
            creditFacilityTemplate.getCreditFacilityTemplateID());
  ...
  private Set<CftVitalInfo> authorizeCftVitalInfo(
      Set<CftVitalInfoTemp> cftVitalInfoTemps, CreditFacilityTemplate creditFacilityTemplate) {
  ...
  private Set<CftInterestRate> authorizeCftInterestRate(
      Set<CftInterestRateTemp> cftInterestRateTemps,
      CreditFacilityTemplate creditFacilityTemplate) {
  ...
  private Set<CftSupportingDoc> authorizeCftSupportingDoc(
      Set<CftSupportingDocTemp> cftSupportingDocTemps,
      CreditFacilityTemplate creditFacilityTemplate) {
  ...
  private Set<CftOtherFacilityInformation> authorizeCftOtherFacilityInformation(
      Set<CftOtherFacilityInformationTemp> cftOtherFacilityInformationTemps,
      CreditFacilityTemplate creditFacilityTemplate) {

    Set<CftOtherFacilityInformation> otherFacilityInformationSet = new HashSet<>();

    for (CftOtherFacilityInformationTemp cftOtherFacilityInformationTemp :
        cftOtherFacilityInformationTemps) {
      CftOtherFacilityInformation cftOtherFacilityInformation = new CftOtherFacilityInformation();

      cftOtherFacilityInformation.setCftOtherFacilityInfoID(
          cftOtherFacilityInformationTemp.getCftOtherFacilityInfoID());
      cftOtherFacilityInformation.setCreditFacilityTemplate(creditFacilityTemplate);
      cftOtherFacilityInformation.setOtherFacilityInfoName(
          cftOtherFacilityInformationTemp.getOtherFacilityInfoName());
      cftOtherFacilityInformation.setDescription(cftOtherFacilityInformationTemp.getDescription());
      cftOtherFacilityInformation.setOtherFacilityInfoCode(
          cftOtherFacilityInformationTemp.getOtherFacilityInfoCode());
      cftOtherFacilityInformation.setOtherFacilityInfoFieldType(
          cftOtherFacilityInformationTemp.getOtherFacilityInfoFieldType());
      cftOtherFacilityInformation.setDefaultValue(
          cftOtherFacilityInformationTemp.getDefaultValue());
      cftOtherFacilityInformation.setDisplayOrder(
          cftOtherFacilityInformationTemp.getDisplayOrder());
      ...
      cftOtherFacilityInformation.setRecordStatus(
          cftOtherFacilityInformationTemp.getRecordStatus());
  ...
  private Set<CftCustomFacilityInfo> authorizeCftCustomFacilityInfo(
      Set<CftCustomFacilityInfoTemp> cftCustomFacilityInfoTemps,
      CreditFacilityTemplate creditFacilityTemplate) {
    ...
    for (CftCustomFacilityInfoTemp cftCustomFacilityInfoTemp : cftCustomFacilityInfoTemps) {
      ...
      cftCustomFacilityInfo.setCftCustomFacilityInfoID(
          cftCustomFacilityInfoTemp.getCftCustomFacilityInfoID());
      cftCustomFacilityInfo.setCreditFacilityTemplate(creditFacilityTemplate);
      cftCustomFacilityInfo.setCustomFacilityInfoName(
          cftCustomFacilityInfoTemp.getCustomFacilityInfoName());
      cftCustomFacilityInfo.setDescription(cftCustomFacilityInfoTemp.getDescription());
      cftCustomFacilityInfo.setCustomFacilityInfoCode(
          cftCustomFacilityInfoTemp.getCustomFacilityInfoCode());
  ...
  @Override
  @Transactional(propagation = Propagation.REQUIRED, rollbackFor = ApiRequestException.class)
  public ResponseEntity<StandardResponse<CreditFacilityTemplateDTO>> updateCreditFacilityTemplate(
      Integer creditFacilityTemplateID, CreditFacilityTemplateDTO creditFacilityTemplateDTO)
    ...
    CreditFacilityTemplate creditFacilityTemplate =
        creditFacilityTemplateRepository
            ...
            .orElseThrow(
                () -> {
                  throw new ApiRequestException(
                      "ROLE_WITH_ID" + creditFacilityTemplateID + DOES_NOT_EXISTS);
                });

    // create temp , save
    creditFacilityTemplateTemp =
        createCreditFacilityTemplateTempObj(creditFacilityTemplateDTO, false);
    creditFacilityTemplateTemp.setApproveStatus(creditFacilityTemplateDTO.getApproveStatus());
    creditFacilityTemplateTemp.setCreditFacilityTemplateID(
        creditFacilityTemplate.getCreditFacilityTemplateID());
  ...
  public ResponseEntity<StandardResponse<Void>> deleteCreditFacilityTemplateTemp(
      Integer creditFacilityTemplateID) {
  ...
  public Set<CftInterestRateTemp> saveCtfInterestRateTemp(
      CreditFacilityTemplateDTO creditFacilityTemplateDTO,
      CreditFacilityTemplateTemp creditFacilityTemplateTemp) {
    Set<CftInterestRateTemp> cftInterestRateTempList = new HashSet<>();

    if (creditFacilityTemplateDTO
        .getIsCftInterestRateDTOListChange()
        .equals(AppsConstants.YesNo.Y)) {

      List<CftInterestRateTemp> existingCftInterestRateTempList =
          cftInterestRateTempRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
              creditFacilityTemplateTemp.getCreditFacilityTemplateID());
      ...
      for (CftInterestRateDTO cftInterestRateDTO :
          creditFacilityTemplateDTO.getCftInterestRateDTOList()) {
        ...
        interestRateTemp.setInterestRatingSubCategory(
            cftInterestRateDTO.getInterestRatingSubCategory());
  ...
  public Boolean insertToCftInterestRateAuditTable(
      CftInterestRate cftInterestRate, CftInterestRateTemp cftInterestRateTemp) {
    ...
    if (cftInterestRateTemp != null && cftInterestRate == null) {
      ...
      cftInterestRateAud.setCreditFacilityTemplate(
          cftInterestRateTemp.getCreditFacilityTemplate() != null
              ? cftInterestRateTemp.getCreditFacilityTemplate().getCreditFacilityTemplateID()
              : null);
      ...
      cftInterestRateAud.setInterestRatingSubCategory(
          cftInterestRateTemp.getInterestRatingSubCategory());
      ...
      cftInterestRateAud.setCreditFacilityTemplate(
          cftInterestRate.getCreditFacilityTemplate() != null
      ...
      cftInterestRateAud.setInterestRatingSubCategory(
          cftInterestRate.getInterestRatingSubCategory());
  ...
  public Set<CftVitalInfoTemp> saveCftVitalInfoTemp(
      CreditFacilityTemplateDTO creditFacilityTemplateDTO,
      CreditFacilityTemplateTemp creditFacilityTemplateTemp) {
    Date date = new Date();
    ...
    if (creditFacilityTemplateDTO.getIsCftVitalInfoDTOListChange().equals(AppsConstants.YesNo.Y)) {
      ...
      List<CftVitalInfoTemp> existingCftVitalInfoTempList =
          cftVitalInfoTempRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
              creditFacilityTemplateTemp.getCreditFacilityTemplateID());
  ...
  public Boolean insertToCftVitalInfoAuditTable(
      CftVitalInfo cftVitalInfo, CftVitalInfoTemp cftVitalInfoTemp) {
    ...
    if (cftVitalInfoTemp != null && cftVitalInfo == null) {
      ...
      cftVitalInfoAud.setCreditFacilityTemplate(
          cftVitalInfoTemp.getCreditFacilityTemplate().getCreditFacilityTemplateID());
  ...
  public Set<CftCustomFacilityInfoTemp> saveCftCustomFacilityInfoTemp(
      CreditFacilityTemplateDTO creditFacilityTemplateDTO,
      CreditFacilityTemplateTemp creditFacilityTemplateTemp) {
    Date date = new Date();
    ...
    if (creditFacilityTemplateDTO
        .getIsCftCustomFacilityInfoDTOListChange()
        .equals(AppsConstants.YesNo.Y)) {

      List<CftCustomFacilityInfoTemp> existingCftCustomFacilityInfoTempList =
          cftCustomFacilityInfoTempRepository
              .findAllByCreditFacilityTemplateCreditFacilityTemplateID(
                  creditFacilityTemplateTemp.getCreditFacilityTemplateID());
      ...
      for (CftCustomFacilityInfoDTO cftCustomFacilityInfoDTO :
          creditFacilityTemplateDTO.getCftCustomFacilityInfoDTOList()) {
        ...
        cftCustomFacilityInfoTemp.setCustomFacilityInfoName(
            cftCustomFacilityInfoDTO.getCustomFacilityInfoName());
        cftCustomFacilityInfoTemp.setCustomFacilityInfoCode(
            cftCustomFacilityInfoDTO.getCustomFacilityInfoCode());
  ...
  public Boolean insertToCftCustomFacilityInfoAuditTable(
      CftCustomFacilityInfo cftCustomFacilityInfo,
      CftCustomFacilityInfoTemp cftCustomFacilityInfoTemp) {
    ...
    if (cftCustomFacilityInfoTemp != null && cftCustomFacilityInfo == null) {
      cftVitalInfoAud.setCftCustomFacilityInfoID(
          cftCustomFacilityInfoTemp.getCftCustomFacilityInfoID());
      cftVitalInfoAud.setCreditFacilityTemplate(
          cftCustomFacilityInfoTemp.getCreditFacilityTemplate().getCreditFacilityTemplateID());
      cftVitalInfoAud.setCustomFacilityInfoName(
          cftCustomFacilityInfoTemp.getCustomFacilityInfoName());
      cftVitalInfoAud.setDescription(cftCustomFacilityInfoTemp.getDescription());
      cftVitalInfoAud.setCustomFacilityInfoCode(
          cftCustomFacilityInfoTemp.getCustomFacilityInfoCode());
      ...
      cftVitalInfoAud.setCftCustomFacilityInfoID(
          cftCustomFacilityInfo.getCftCustomFacilityInfoID());
      cftVitalInfoAud.setCreditFacilityTemplate(
          cftCustomFacilityInfo.getCreditFacilityTemplate().getCreditFacilityTemplateID());
  ...
  public Set<CftSupportingDocTemp> saveCftSupportingDocTemp(
      CreditFacilityTemplateDTO creditFacilityTemplateDTO,
      CreditFacilityTemplateTemp creditFacilityTemplateTemp) {
    Date date = new Date();
    Set<CftSupportingDocTemp> cftSupportingDocTempList = new HashSet<>();
    if (creditFacilityTemplateDTO
        .getIsCftSupportingDocDTOListChange()
        .equals(AppsConstants.YesNo.Y)) {

      List<CftSupportingDocTemp> existingCftSupportingDocTempList =
          cftSupportingDocTempRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
              creditFacilityTemplateTemp.getCreditFacilityTemplateID());
      ...
      for (CftSupportingDocDTO cftSupportingDocDTO :
          creditFacilityTemplateDTO.getCftSupportingDocDTOList()) {

        SupportingDoc supportingDoc =
            supportingDocRepository
                .findById(cftSupportingDocDTO.getSupportingDocID())
                .orElseThrow(
                    () ->
                        new ApiRequestException(
                            "Supporting Doc with ID "
                                + cftSupportingDocDTO.getSupportingDocID()
                                + " does not exist."));
  ...
  public Boolean insertToCftSupportingDocAuditTable(
      CftSupportingDoc cftSupportingDoc, CftSupportingDocTemp cftSupportingDocTemp) {
    ...
    if (cftSupportingDocTemp != null && cftSupportingDoc == null) {
      ...
      cftSupportingDocAud.setCreditFacilityTemplate(
          cftSupportingDocTemp.getCreditFacilityTemplate().getCreditFacilityTemplateID());
      cftSupportingDocAud.setSupportingDoc(
          cftSupportingDocTemp.getSupportingDoc().getSupportingDocID());
      ...
      cftSupportingDocAud.setSupportingDoc(
          cftSupportingDoc.getSupportingDoc().getSupportingDocID());
  ...
  public Set<CftOtherFacilityInformationTemp> saveCftOtherFacilityInfoTemp(
      CreditFacilityTemplateDTO creditFacilityTemplateDTO,
      CreditFacilityTemplateTemp creditFacilityTemplateTemp) {
    Date date = new Date();
    ...
    if (creditFacilityTemplateDTO
        .getIsCftOtherFacilityInfoDTOListChange()
        .equals(AppsConstants.YesNo.Y)) {

      List<CftOtherFacilityInformationTemp> existingCftOtherFacilityInformationTempList =
          otherFacilityInfoTempRepository.findAllByCreditFacilityTemplateCreditFacilityTemplateID(
              creditFacilityTemplateTemp.getCreditFacilityTemplateID());
      ...
      for (CftOtherFacilityInfoDTO facilityInfoDTO :
          creditFacilityTemplateDTO.getCftOtherFacilityInfoDTOList()) {

        CftOtherFacilityInformationTemp cftOtherFacilityInformationTemp =
            new CftOtherFacilityInformationTemp();
        ...
        cftOtherFacilityInformationTemp.setOtherFacilityInfoCode(
            facilityInfoDTO.getOtherFacilityInfoCode());
        cftOtherFacilityInformationTemp.setOtherFacilityInfoName(
            facilityInfoDTO.getOtherFacilityInfoName());
        cftOtherFacilityInformationTemp.setDescription(facilityInfoDTO.getDescription());
        cftOtherFacilityInformationTemp.setOtherFacilityInfoFieldType(
            facilityInfoDTO.getOtherFacilityInfoFieldType());
  ...
  public Boolean insertToCftOtherFacilityInfoAuditTable(
      CftOtherFacilityInformation cftOtherFacilityInformation,
      CftOtherFacilityInformationTemp cftOtherFacilityInformationTemp) {

    CftOtherFacilityInformationAud cftOtherFacilityInformationAud =
        new CftOtherFacilityInformationAud();

    if (cftOtherFacilityInformationTemp != null && cftOtherFacilityInformation == null) {
      cftOtherFacilityInformationAud.setCftOtherFacilityInfoID(
          cftOtherFacilityInformationTemp.getCftOtherFacilityInfoID());
      cftOtherFacilityInformationAud.setCreditFacilityTemplate(
          cftOtherFacilityInformationTemp
              .getCreditFacilityTemplate()
              .getCreditFacilityTemplateID());
      cftOtherFacilityInformationAud.setOtherFacilityInfoName(
          cftOtherFacilityInformationTemp.getOtherFacilityInfoName());
      cftOtherFacilityInformationAud.setDescription(
          cftOtherFacilityInformationTemp.getDescription());
      cftOtherFacilityInformationAud.setOtherFacilityInfoCode(
          cftOtherFacilityInformationTemp.getOtherFacilityInfoCode());
      cftOtherFacilityInformationAud.setOtherFacilityInfoFieldType(
          cftOtherFacilityInformationTemp.getOtherFacilityInfoFieldType());
      cftOtherFacilityInformationAud.setDefaultValue(
          cftOtherFacilityInformationTemp.getDefaultValue());
      cftOtherFacilityInformationAud.setDisplayOrder(
          cftOtherFacilityInformationTemp.getDisplayOrder());
      ...
      cftOtherFacilityInformationAud.setCreatedDate(
          cftOtherFacilityInformationTemp.getCreatedDate());
      cftOtherFacilityInformationAud.setLastModifiedDate(
          cftOtherFacilityInformationTemp.getLastModifiedDate());
      cftOtherFacilityInformationAud.setRecordStatus(
          cftOtherFacilityInformationTemp.getRecordStatus());
    } else {
      cftOtherFacilityInformationAud.setCftOtherFacilityInfoID(
          cftOtherFacilityInformation.getCftOtherFacilityInfoID());
      cftOtherFacilityInformationAud.setCreditFacilityTemplate(
          cftOtherFacilityInformation.getCreditFacilityTemplate().getCreditFacilityTemplateID());
      cftOtherFacilityInformationAud.setOtherFacilityInfoName(
          cftOtherFacilityInformation.getOtherFacilityInfoName());
      cftOtherFacilityInformationAud.setDescription(cftOtherFacilityInformation.getDescription());
      cftOtherFacilityInformationAud.setOtherFacilityInfoCode(
          cftOtherFacilityInformation.getOtherFacilityInfoCode());
      cftOtherFacilityInformationAud.setOtherFacilityInfoFieldType(
          cftOtherFacilityInformation.getOtherFacilityInfoFieldType());
      ...
      cftOtherFacilityInformationAud.setLastModifiedDate(
          cftOtherFacilityInformation.getLastModifiedDate());
  ...
  public void validateRoleNameUniqueness(String roleName) throws ApiRequestException {
    ...
    BooleanBuilder tempQuery =
        new BooleanBuilder(
            QCreditFacilityTemplateTemp.creditFacilityTemplateTemp.creditFacilityName.eq(roleName));
    ...
    BooleanBuilder masterQuery =
        new BooleanBuilder(
            QCreditFacilityTemplate.creditFacilityTemplate.creditFacilityName.eq(roleName));
    if (creditFacilityTemplateRepository.exists(masterQuery)) {
      throw new ApiRequestException(
          "Credit Facility Template Name Already Exists in Master Records");
    }
  }
}
