...
public interface DeviationService {
  ...
  ResponseEntity<StandardResponse<DeviationTypeDTO>> getDeviationTypeById(Integer deviationTypeId)
      throws ApiRequestException;

  ResponseEntity<StandardResponse<DeviationDTO>> saveOrUpdateDeviation(DeviationDTO deviationDTO)
      throws ApiRequestException;

  ResponseEntity<StandardResponse<DeviationDTO>> approveOrRejectDeviation(
      ApproveRejectRQ approveRejectRQ) throws ApiRequestException;

  ResponseEntity<StandardResponse<DeviationDTO>> updateApprovedDiversion(DeviationDTO deviationDTO)
      throws ApiRequestException;

  ResponseEntity<StandardResponse<List<DeviationDTO>>> getAllDeviationTempList()
      throws ApiRequestException;

  ResponseEntity<StandardResponse<DeviationDTO>> getDeviationTempById(Integer deviationId)
      throws ApiRequestException;

  ResponseEntity<StandardResponse<List<DeviationDTO>>> getAllDeviationMasterList()
      throws ApiRequestException;

  ResponseEntity<StandardResponse<DeviationDTO>> getDeviationMasterById(Integer deviationId)
      throws ApiRequestException;
}
