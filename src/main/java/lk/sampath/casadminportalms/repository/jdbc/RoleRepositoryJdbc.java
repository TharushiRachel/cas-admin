...
public class RoleRepositoryJdbc {
    ...
    public List<RoleDTO> viewAllRolesTemp(boolean isTemp, boolean excludeApproved) {
        ...
        return namedParameterJdbcTemplate.query(SQL.toString(), params, new RowMapper<RoleDTO>() {
            @Nullable
            @Override
            public RoleDTO mapRow(ResultSet rs, int i) throws SQLException {
                ...
                roleDTO.setApproveStatus(MasterDataApproveStatus.valueOf(rs.getString("APPROVE_STATUS")));
