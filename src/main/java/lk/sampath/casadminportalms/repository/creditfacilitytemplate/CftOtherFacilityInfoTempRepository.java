...
@Repository
public interface CftOtherFacilityInfoTempRepository
    extends JpaRepository<CftOtherFacilityInformationTemp, Integer> {
  ...
  List<CftOtherFacilityInformationTemp> findAllByCreditFacilityTemplateCreditFacilityTemplateID(
