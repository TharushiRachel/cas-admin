...
@Repository
public interface CftSupportingDocTempRepository
    extends JpaRepository<CftSupportingDocTemp, Integer> {

  @Query(value = "SELECT SEQ_T_CFT_SUPPORTING_DOC.NEXTVAL FROM DUAL", nativeQuery = true)
  Integer getNextSequenceValue();

  List<CftSupportingDocTemp> findAllByCreditFacilityTemplateCreditFacilityTemplateID(
