...
public class UpmGroupJdbc {
    ...
    private final RowMapper<UpmGroupDTO> upmGroupRowMapper = (rs, rowNum) -> {
        ...
        dto.setApproveStatus(MasterDataApproveStatus.resolveApproveStatus(rs.getString("APPROVE_STATUS")));
